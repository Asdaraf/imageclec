...
export default function CentrosMedicosPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      ...
      {/* Hero Section */}
      <section className="py-20 px-8 text-center bg-gradient-to-r from-[#2F75B5] to-[#144A7B] text-white">
        ...
        <button className="bg-yellow-400 text-[#144A7B] hover:bg-yellow-300 px-8 py-4 rounded-lg transition-colors font-semibold text-lg flex items-center mx-auto gap-2">
          <a href="/contact">
      ...
      <section className="py-16 px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-4xl font-bold text-center mb-12 text-[#144A7B]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                <Users className="text-[#2F75B5] mr-3" size={24} />
                <h4 className="text-xl font-semibold text-[#144A7B]">Ecografistas Cualificados</h4>
              </div>
              <p className="text-gray-700 mb-4">
                Conectamos con ecografistas altamente capacitados para atender a tus usuarios, asegurando un servicio de calidad.
              </p>
              <Link to="/faq" className="text-[#2F75B5] hover:underline font-medium">
                Ver más detalles →
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-[#144A7B]">Equipamiento e Informes Médicos</h4>
              </div>
              <p className="text-gray-700 mb-4">
                Te proporcionamos el ecógrafo y los informes emitidos por Médicos Radiólogos.
              </p>
              <Link to="/faq" className="text-green-600 hover:underline font-medium">
                Ver más detalles →
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-[#144A7B]">Almacenamiento Seguro</h4>
              </div>
              <p className="text-gray-700 mb-4">
                Implementamos plataforma PACS para el almacenamiento de estudios por 5 años y envío en formato DICOM.
              </p>
              <Link to="/faq" className="text-purple-600 hover:underline font-medium">
                Ver más detalles →
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-[#144A7B]">Reportes Mensuales Personalizados</h4>
              </div>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-[#144A7B]">ROI Positivo desde el Primer Día</h4>
              </div>
              <p className="text-gray-700 mb-4">
                Nuestra modalidad de cobro es por atenciones realizadas, garantizando un Retorno de Inversión positivo.
              </p>
              <Link to="/faq" className="text-red-600 hover:underline font-medium">
                Ver más detalles →
              </Link>
            </div>

            {/* Aliados en Diagnóstico */}
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                <MessageSquare className="text-teal-600 mr-3" size={24} />
                <h4 className="text-xl font-semibold text-[#144A7B]">Aliados en el Diagnóstico por Imagen</h4>
              </div>
              <p className="text-gray-700 mb-4">
      ...
      {/* CTA Section */}
      <section className="py-16 px-8 bg-gradient-to-r from-[#144A7B] to-[#2F75B5] text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact" className="bg-white text-[#144A7B] hover:bg-gray-100 px-8 py-4 rounded-lg transition-colors font-semibold text-lg flex items-center justify-center gap-2">
              <Send size={20} />
              Contáctanos
            </Link>
          </div>
